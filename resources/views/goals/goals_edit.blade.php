   ...
   <div class="graphs">
      <div class="hide-on-mobile">
         <!--<div class="graphs">
            <div class="hide-on-mobile"> -->
         <!--Section-->
		{!! Form::open(array('action' => 'GoalsController@update')) !!}
                     ...
                     <div class="content">
                      ...
                      <!--<a href="#" data-perform="panel-collapse" class="btn"><i class="fa fa-plus"></i></a>--> 
                        ...
                        <div class="panel-wrapper collapse in goal-row-child">
							...
							<input type="hidden" name="id" value="{{ $goals_edit->id}}">
                            <input placeholder="Goal&#039;s name" style="" class=" first-text main-goal-text" id="" type="text" value="{{ $goals_edit->name}}" name="name" />
							<div id='sub-rep'>
            ...
            <div class="goal-create-details fullhalfheightsec">
               <div class="section">
                  <header>
                     ...
                     <textarea name="status" id="status">{{ $goals_edit->status}}</textarea>
                  </header>
               </div>
               <!--//Section Ends--> 
               <div class="section">
                  <header>
                     ...
                     <textarea name="improvement" id="improvement">{{ $goals_edit->improvement}}</textarea>
                  </header>
               </div>
               <div class="section">
                  <header>
                     ...
                     <textarea name="risk" id="risk">{{ $goals_edit->risk}}</textarea>
                  </header>
               </div>
               <div class="section">
                  <header>
                     ...
                     <textarea name="benefits" id="benefits">{{ $goals_edit->benefits}}</textarea>
                  </header>
               </div>
               <div class="section">
                  <header>
                     ...
                     <textarea name="vision" id="vision">{{ $goals_edit->vision}}</textarea>
                  </header>
               </div>
               <div class="section">
                  <header>
                     ...
                     <textarea name="vision_decades" id="vision_decades">{{ $goals_edit->vision_decades}}</textarea>
                  </header>
               </div>
               <div class="section">
                  <header>
                     ...
                     <textarea name="barriers" id="barriers">{{ $goals_edit->barriers}}</textarea>
                  </header>
               </div>
               <div class="section">
                  <header>
                     ...
                     <textarea name="priority" id="priority">{{ $goals_edit->priority}}</textarea>
                  </header>
               </div>
               <div class="section">
                  <header>
                     ...
                     <textarea name="initiative" id="initiative">{{ $goals_edit->initiative}}</textarea>
                  </header>
               </div>
               <div class="section">
                  <header>
                     ...
                     <textarea name="help" id="help">{{ $goals_edit->help}}</textarea>
                  </header>
               </div>
               <div class="section">
                  <header>
                     ...
                     <textarea name="support" id="support">{{ $goals_edit->support}}</textarea>
                  </header>
               </div>
               <div class="section">
                  <header>
                     ...
                     <textarea name="environment" id="environment">{{ $goals_edit->environment}}</textarea>
                  </header>
               </div>
               <div class="section">
                  <header>
                     ...
                     <textarea name="imagery" id="imagery">{{ $goals_edit->imagery}}</textarea>
