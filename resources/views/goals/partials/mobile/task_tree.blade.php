...
<ul class="task-list task-main-tree" id="task-mobile"> 
        ...
        <li class="<?php echo $task->list_collapse?"child-expand":"child-collapse"; ?> task-item mainchild" id="item_<?php echo $task->id?>" data-order="<?php echo $task->self_order?>">
                        ...
                        <a class="like btnEnd " data-id="<?php echo $task->id?>" data-view="<?php echo $list_type; ?>" href="javascript:void(0);">
                            ...
                            <span class="task-content-div">
                                ...
                                <?php } 
                                    ...
                                    $substr_max=($has_child || $completed_percetange)?20:50;
            ...
            if($has_child){
            ?>
            @include('goals.partials.mobile.task_tree_child',['children'=>$task->children,"top_parent"=>$top_parent])
            <?php } ?>
            </li>
    <?php }
    }
