...
?>
<ul class="task-list task-main-tree task-list-tree task-list-tree-desktop" id="task"> 
        ...
        <?php
            ...
            ?>
        <li class="<?php echo $task->list_collapse?"child-expand":"child-collapse"; ?> task-item mainchild task-desk-tree" id="item_<?php echo $task->id?>" data-order="<?php echo $task->self_order?>">
            ...
            if($has_child){
            ?>
            @include('goals.partials.task_tree_child',['children'=>$task->children,"top_parent"=>$top_parent])
            <?php } ?>
            </li>
    <?php }
    }
