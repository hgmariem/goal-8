                     ...
                     <div class="content">
                      ...
                      <!--<a href="#" data-perform="panel-collapse" class="btn"><i class="fa fa-plus"></i></a>--> 
                        ...
                        <div class="panel-wrapper collapse in goal-row-child">
                            ...
                            <input placeholder="Goal&#039;s name" style="" class=" first-text main-goal-text" id="" type="text" value="" name="name" />                            <div id='sub-rep'>
            ...
            <div class="goal-create-details fullhalfheightsec">
               ...
               <div class="section">
                  <header>
                     ...
                     <textarea name="risk" id="risk"></textarea>
                  </header>
               </div>
               <div class="section">
                  <header>
               ...
               <div class="section">
                  <header>
                     ...
                     <textarea name="vision_decades" id="vision_decades"></textarea>
                  </header>
               </div>
               <div class="section">
                  <header>
                     ...
                     <textarea name="barriers" id="barriers"></textarea>
                  </header>
               </div>
               <div class="section">
                  <header>
               ...
               <div class="section">
                  <header>
                     ...
                     <textarea name="initiative" id="initiative"></textarea>
                  </header>
               </div>
               <div class="section">
                  <header>
               ...
               <div class="section">
                  <header>
                     ...
                     <textarea name="imagery" id="imagery"></textarea>
                     <input id="checkChanged" type="hidden" value="" name="modified" />
                  </header>
               </div>
               <div class="section">
                  <div class="autosave-notify"></div>
                  <input name="saveandclose" id="saveandclose" class="submit" type="button" value="SAVE AND CLOSE" />     
				  <input type="hidden" name="goal_id" id="_goal_id" value="">
