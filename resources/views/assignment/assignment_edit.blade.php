                    ...
                    <div class="col-md-7XX no-padXX" id="add-form">
                        ...
                        <div class="goal-create-details">
                            ...
                            <div class="section">
                                <header>
                                    <h4>Assignment</h4>
                                    <input type="hidden" name="id" id="assignmentId" value="{{ $assigment_data->id }}">
                                    <input placeholder="Assignment's title" class="assignmentinput form-control" type="text" value="{{ $assigment_data->name }}" name="name" id="name"> </header>
                            </div>
                            <!--//Section Ends-->
                            <!--Section-->
                            <div class="section">
                                <header>
                                    <h4>Content</h4>
                                    <textarea name="content" id="content" >{{ $assigment_data->content }}</textarea>
...
<script src="{{ URL::asset('/ckeditor/config.js') }}"></script>
