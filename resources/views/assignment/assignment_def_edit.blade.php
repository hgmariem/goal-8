        ...
        <section class="lobby-goals-rows col-lg-12 no-pad">
            ...
            <section class="goasl">
                ...
                <div class="col-md-7XX no-padXX" id="add-form">
                            ...
                            <tr class="yellow-head">
                                <th colspan="4" class="heading">
                                    <div class="dropdown gls">
                                        ...
                                        <button class="btn btn-primary dropdown-toggle opendropdown" type="button" data-toggle="dropdown">Edit Default Assignment</button>
                    ...
                    {!! Form::open(array('action' => 'AssignmentController@defupdate')) !!}
                    ...
                    <div class="goal-create-details">
                        ...
                        <div class="section">
                            <header>
                                <h4>Assignment</h4>
                                <input type="hidden" name="id" value="{{ $defassigment_data->id }}">
                                <input placeholder="Assignment's title" class="assignmentinput form-control" type="text" value="{{ $defassigment_data->name }}" name="name" id="name" readonly> </header>
                        </div>
                        <!--//Section Ends-->
                        <!--Section-->
                        <div class="section">
                            <header>
                                <h4>Content</h4>
                                <textarea name="content" id="content" class="_editor">{{ nl2br($defassigment_data->content) }}</textarea>
